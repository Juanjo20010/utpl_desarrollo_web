...
Class Usuario
{
	...
	{
		$sql="INSERT INTO usuario (nombre,tipo_documento,num_documento,direccion,telefono,email,login,clave,imagen,activo)
    ...
    {
    	$sql="SELECT idusuario,nombre,tipo_documento,num_documento,telefono,email,imagen,login FROM usuario WHERE login='$login' AND clave='$clave' AND activo='1'"; 
    	return ejecutarConsulta($sql);  
    }
}
